...
/* Terminal Types that describe external audio I/O connections */
enum USB_Audio_TT_ExternalTermType_t
{
    UAC_TT_EXTERNAL_TERMTYPE_UNDEFINED                  = 0x0600,
    UAC_TT_EXTERNAL_TERMTYPE_ANALOG_CONNECTOR           = 0x0601,
    UAC_TT_EXTERNAL_TERMTYPE_DIGITAL_AUDIO_INTERFACE    = 0x0602,
    UAC_TT_EXTERNAL_TERMTYPE_LINE_CONNECTOR             = 0x0603,
    UAC_TT_EXTERNAL_TERMTYPE_LEGACY_AUDIO_CONNECTOR     = 0x0604,
    UAC_TT_EXTERNAL_TERMTYPE_SPDIF_INTERFACE            = 0x0605,
    UAC_TT_EXTERNAL_TERMTYPE_1394_DA_STREAM             = 0x0606,
    UAC_TT_EXTERNAL_TERMTYPE_1394_DV_SOUNDTRACK         = 0x0607
};
